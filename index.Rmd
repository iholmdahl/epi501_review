...
- Intro to R 
    - [Swirl Tutorial](http://swirlstats.com/students.html): If you've never used `R` before, we highly recommend doing this tutorial and the Software Company tutorial, below.
    ...
    - [Super quick `R` Review](./spring_2017/jan25-intro-to-r/index.html): If you've used `R` in the past but need a refresher, this is a tutorial the previous TF Matt Kiang made for this class in Spring 2017.
    - [Shiny app for ODE models](https://mkiang.shinyapps.io/DiseaseDynamics/): Also made by Matt: an interactive example of what we'll be doing throughout the course.
